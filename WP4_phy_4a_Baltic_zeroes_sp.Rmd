...
params:
  targetSpecies: "Pseudo-nitzschia delicatissima" # Alternatively "Nitzschia longissima" ## Change species depending on preference
  begin: 1995
  end: 2020
  gridX: 35000
  gridY: 35000
...
```{r plot1a, fig.height = height_plot1, fig.fullwidth = TRUE, results='asis', dpi = 184}
...
```{r plot1b, fig.height = 2, fig.width = 6, results='asis', dpi = 184}
